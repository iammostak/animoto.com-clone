   ...
   return (
      <div className="footer">
         <div className="footer-content">
            {list.map((item) => (
               <ListCard key={item.id} title={item.title} data={item.data} />
            ))}
            <div>
               <h4>CONNECT</h4>
               <div>
                  ...
                  <a
                     href="https://www.youtube.com/channel/UCeqtYy6WpYkZ3Q_EUnY0fVQ"
                     target="_blank"
                  >
                     <BsYoutube
                        style={{
                  ...
                  <a
                     href="https://www.linkedin.com/company/animoto/"
                     target="_blank"
                  >
                     <FaLinkedinIn
                        style={{
               ...
               <div>
                  <a
                     href="https://www.facebook.com/business/solutions-explorer/campaign_management/144864402752633/Animoto"
                     target="_blank"
                  >
                     <img
                        src="https://animoto.com/static/FacebookPartnerIcon-4f675b081bec613dbac01a85deceacb3.svg"
                        alt="facebook business partner"
                        className="partner-logo-fb"
                     />
                  </a>
               </div>
               <div>
                  <a
                     href="https://support.google.com/youtube/answer/6145904"
                     target="_blank"
                  >
                     <img
                        src="https://animoto.com/static/YoutubePartnerIcon-c1d64a90323f18e6780043bcfcd98978.svg"
                        alt="youtube business partner"
                        className="partner-logo-yt"
                     />
                  </a>
               </div>
            </div>
